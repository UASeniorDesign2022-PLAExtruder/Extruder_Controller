...
I2CBase::I2CBase(const I2CBase& orig)
{
...
void I2CBase::I2C_wait_for_idle(void)
{
    while (I2C1CON & 0x1F);
    while (I2C1STATbits.TRSTAT);
}

void I2CBase::I2CStart( void )
{
    I2C_wait_for_idle();
...
bool I2CBase::I2Csendbyte(char data)
{
