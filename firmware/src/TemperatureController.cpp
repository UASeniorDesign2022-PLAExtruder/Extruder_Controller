...
TemperatureController::TemperatureController(bool zone_1_active, bool zone_2_active, bool zone_3_active)
{
    temp_control_turn_on(zone_1_active, zone_2_active, zone_3_active);
}
...
void TemperatureController::temp_control_turn_on(bool zone_1_active, bool zone_2_active, bool zone_3_active)
{
    if (zone_1_active)
    {
...
void TemperatureController::temp_control_turn_off_all(void)
{
...
void TemperatureController::temp_control_turn_off_zone(uint8_t current_zone)
{
    switch(current_zone)
    {
        case 1:
...
uint16_t TemperatureController::temp_control_compare_actual_to_target(uint8_t current_zone, short current_delay, uint16_t actual_temp, uint16_t target_temp)
{
...
void TemperatureController::temp_control_calculate_new_delays(void)
{
...
void TemperatureController::temp_control_compare_new_delay_lengths(void)
{
...
void TemperatureController::temp_control_calculate_relative_delays(void)
{
...
void TemperatureController::temp_control_update_delays(void)
{
